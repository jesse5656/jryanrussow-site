...
var worker_default = {
  async fetch(request, env) {
    ...
    const skip = url.pathname.startsWith("/css/") || url.pathname.startsWith("/js/") || url.pathname.startsWith("/partials/") || url.pathname.match(
    ...
    return new HTMLRewriter().on("#site-header-mount", {
      element(el) {
